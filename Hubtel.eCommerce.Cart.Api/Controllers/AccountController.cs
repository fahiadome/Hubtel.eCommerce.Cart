...
namespace Hubtel.eCommerce.Cart.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        {
            var result = await AccountLogin(model);

            return string.IsNullOrEmpty(result) ? (IActionResult) Unauthorized() : Ok(result);
        }

        private async Task<string> AccountLogin(LoginModel model)
        {
